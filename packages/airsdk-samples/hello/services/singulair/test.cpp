...
#define MSGHUB_ADDR "unix:/tmp/hello-nn-service"
...
static int context_start(struct context *ctx)
{
	/* msg */
	ctx->msg_channel =
		ctx->msg->startServerChannel(pomp::Address(MSGHUB_ADDR), 0667);
...
{
	ULOGW("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW");
	int res = 0;
